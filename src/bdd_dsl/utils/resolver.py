...
from bdd_dsl.models.uri import URL_SECORO, URL_COMP_ROB2B
from bdd_dsl.utils.common import BDD_DSL_VERSION


__PKG_CACHE_ROOT = join(platformdirs.user_cache_dir(), "bdd-dsl")
...
def install_resolver(
    ...
    For Linux this should be `$HOME/.cache/bdd-dsl/`.
    """
    if resolver is None:
        if url_map is None:
            url_map = {
